package com.example.etlkycsimregisterapi.login;

import com.example.etlkycsimregisterapi.db.AuthenETLConfigUser;
import com.example.etlkycsimregisterapi.global.GlobalParameter;
import com.example.etlkycsimregisterapi.model.LoginModel;
import com.example.etlkycsimregisterapi.security.GenerateSignkey_sha256;
import com.example.etlkycsimregisterapi.security.JWT_Security_Encode_Decode_Java;
import com.example.etlkycsimregisterapi.security.sha256encrypt;
...
//		}
    ...
    public LoginModel login(@RequestParam(defaultValue = "") String sign,
        ...
        if (userName.equals("") || password.equals("") || channel.equals("") || transactionNo.equals("")
        ...
        String serverSign = signkey_sha256.generateSignkey_sha256(userName,
                channel, transactionNo, mobileNumber,
        ...
        try {
            if (serverSign.equals(sign.trim())) {
                ...
                String passwordEncr;
                passwordEncr = kSha256encrypt.getSha256encrypt(password);
