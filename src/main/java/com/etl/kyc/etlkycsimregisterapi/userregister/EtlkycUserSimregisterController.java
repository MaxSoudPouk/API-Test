package com.etl.kyc.etlkycsimregisterapi.userregister;
...
@RestController
public class EtlkycUserSimregisterController extends Thread {
    ...
    public EtlkycUserSimregisterController() {
    ...
    private void setRequest(HttpServletRequest request) {
        EtlkycUserSimregisterController.request = request;

    }

    @PostMapping("/v1/Usersimregister")
    public UserregisterModel UserSimregister(
        ...
        if (channel.equals("")
            ...
            usermodel.setResultCode(GlobalParameter.error_not_acceptable);
            usermodel.setResultMsg(GlobalParameter.error_not_acceptable_msg);
            usermodel.setExtraPara("n");
        ...
        String des_url = "/etllao.com/v1/userregister";
...
//=====================================================================
            ...
            if (jwtencoderesult) {
                ...
                try {
                    ...
                    if (rsfound > 0) {
                        usermodel.setResultCode(GlobalParameter.fail_query_status);
                        usermodel.setResultMsg(GlobalParameter.fail_query_status_msg);
                        usermodel.setTransactionID(transactionNo);
                        usermodel.setExtraPara("n");
                    ...
                    usermodel.setResultCode(GlobalParameter.error_querymobile_status);
                    usermodel.setResultMsg(GlobalParameter.error_querymobile_status_msg);
                    usermodel.setTransactionID(transactionNo);
                    return usermodel;
...
//		          System.out.println("hostname=" + hostname);
                    ...
                    usermodel.setResultCode(GlobalParameter.error_upload_image);
                    usermodel.setResultMsg(GlobalParameter.error_upload_image_msg);
                    usermodel.setTransactionID(transactionNo);
                    usermodel.setExtraPara("n");
...
//						Connection conntAuth = null;
                    ...
                    try {
                        ...
                        if (rowsUpdated > 0) {
                            ...
                            usermodel.setResultCode(GlobalParameter.error_ok_success);
                            usermodel.setResultMsg(GlobalParameter.error_ok_success_msg);
                            usermodel.setTransactionID(transactionNo);
                            usermodel.setExtraPara("n");
                        ...
                        usermodel.setResultCode(GlobalParameter.error_insert_sim_register);
                        usermodel.setResultMsg(GlobalParameter.error_insert_sim_register_smg);
                        usermodel.setTransactionID(transactionNo);
                        usermodel.setExtraPara("n");
                    ...
                    usermodel.setResultMsg(GlobalParameter.error_upload_image_msg);
                    usermodel.setTransactionID(transactionNo);
                    usermodel.setExtraPara("Error Upload image");
                ...
                usermodel.setResultCode(GlobalParameter.error_invalidtoken);
                usermodel.setResultMsg(GlobalParameter.error_invalidtoken_msg);
                usermodel.setTransactionID(transactionNo);
                usermodel.setExtraPara("n");
            ...
            usermodel.setResultCode(GlobalParameter.error_non_authoritative_sign);
            usermodel.setResultMsg(GlobalParameter.error_non_authoritative_msg_sign);
            usermodel.setTransactionID(transactionNo);
            usermodel.setExtraPara("n");
